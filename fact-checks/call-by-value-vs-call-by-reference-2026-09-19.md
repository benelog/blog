...
- 이전 기록: [2026-09-19 1차 검증](call-by-value-2026-09-19.md), [2026-09-19 2차 검증](call-by-value-2026-09-19-2.md), [2026-09-19 3차 검증](call-by-value-2026-09-19-3.md). 앞의 세 기록은 글 파일명을 바꾸기 전의 slug(`call-by-value`)로 저장했다. 3차 이후 Java 절에 JLS·JVMS의 프레임 설명과 draw.io 다이어그램(`java-stack-frames`)을 추가했고, 기존 SVG 그림 두 개를 draw.io로 다시 그렸다.
