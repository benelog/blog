...
2진수에서 0이 아닌 한 자리 숫자는 1뿐이므로, 이렇게 정규화한 결과는 언제나 ±1.가수 × 2^지수^ 꼴이 됩니다.
...
다음 절에서는 자바에서 이 오차를 피하는 대안을 살펴봅니다.
...
저는 기본적으로는 여전히 ``BigDecimal``을 권장해야 한다고 생각합니다.
