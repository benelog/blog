...
단가는 위 표처럼 목적지로 갈리는데, 무료 1GB는 **출발지**에 붙습니다.
...
* **Cloud Run 서비스 사용량 외의 비용 항목이 있습니다.** 소스 배포는 Cloud Build와 Artifact Registry를 사용하고, 외부 데이터 전송도 Cloud Run 요청·CPU·메모리 한도와 별개입니다. 특히 한국으로 나가는 응답에는 무료 구간이 없어 $0.19/GiB가 0GiB부터 적용됩니다.
