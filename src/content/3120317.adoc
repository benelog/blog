...
(자세한 설명은 http://helloworld.naver.com/helloworld/645609[Java의 날짜와 시간 API],전체 소스는 https://github.com/benelog/blog/blob/main/examples/java-date-time/jdk7-date-time/src/test/java/com/nbp/weblab/date/OldJdkDateTest.java[OldJdkDateTest.java)] 참조)
