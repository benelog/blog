...
https://m.yeongnam.com/view.php?key=20110726.010061333590001[영남일보 기사]는 그 오차의 원인을 더 구체적으로 전합니다.
...
같은 점검 결과를 다룬 https://www.yna.co.kr/view/AKR20110902079600004[연합뉴스 기사]는 동점자 처리의 '오류 보정 코드'를 일부 프로그램에 적용하지 않았다고 지목합니다.
