...
== ApplicationContext의 스케줄링 설정 파일
...
QuartzCronExpressionTestUtils.findTriggerByName 메서드는 List<CronTrigger> 타입의 객체가 담고 있는 여러개의 CronTrigger에서 지정된 이름의 CronTrigger를 반환해줍니다.
